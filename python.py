...
lb_sc=Label(clk,text="12",font=("times 20 bold",75,"bold"),bg="#068488",fg="white")
lb_sc.place(x=690,y=200,width=150,height=150)


lb_sc_txt = Label(clk,text="SECOND",font=("times 20 bold",20,"bold"),bg="#068488",fg="white")
